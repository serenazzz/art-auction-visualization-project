...
ggplot(art_final, aes(x= hammer_price_bp_usd)) + geom_histogram(aes(y=..density..))  + geom_density(col="blue") + xlim(0,1500000)+ theme_minimal() +xlab("Price") +ylab("Density") +ggtitle("Hammer Price Distribution (New)")+ theme(plot.title = element_text(hjust = 0.5,face="bold"))
```
...
From the graph it can be seen that Milan, London and New York have the highest average lot price. Which confirms our assumption from part 1 that New York and London are the main hubs for art exchange. 
